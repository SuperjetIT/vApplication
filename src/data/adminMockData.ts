...
export const PIPELINE_STAGES = [
  { stage: 'New Lead', count: 284, width: '100%', color: '#5057ea' },
...
export const MOCK_LEADS: AdminLead[] = [
  ...
  { id: '3', name: 'Mohammed Ali', email: 'm.ali@email.com', passport: 'Pakistan', passportCode: 'pk', destination: 'Schengen', destCode: 'fr', source: 'B2B', status: 'New Lead', assigned: 'Unassigned', created: '1 hr ago', visaType: 'Schengen' },
  ...
  { id: '6', name: 'Fatima Al Mansouri', email: 'fatima@email.com', passport: 'UAE', passportCode: 'ae', destination: 'Schengen', destCode: 'fr', source: 'B2C', status: 'New Lead', assigned: 'Unassigned', created: '8 min ago', visaType: 'Tourist' },
  ...
  { id: '19', name: 'Tom Becker', email: 'tom.b@email.com', passport: 'Germany', passportCode: 'de', destination: 'Kenya', destCode: 'ke', source: 'B2C', status: 'New Lead', assigned: 'Unassigned', created: '5 days ago', visaType: 'e-Visa' },
...
export const MOCK_CUSTOMERS: AdminCustomer[] = [
  { id: '1', name: 'Ahmed Hassan', email: 'ahmed.h@email.com', phone: '+971 50 123 4567', nationality: 'India', applications: 3, totalSpent: 1386, lastActive: '2 min ago' },
  { id: '2', name: 'Priya Sharma', email: 'priya.s@email.com', phone: '+971 55 234 5678', nationality: 'India', applications: 2, totalSpent: 924, lastActive: '1 hr ago' },
  { id: '3', name: 'Mohammed Ali', email: 'm.ali@email.com', phone: '+971 52 345 6789', nationality: 'Pakistan', applications: 1, totalSpent: 462, lastActive: '3 hr ago' },
  { id: '4', name: 'Sarah Johnson', email: 'sarah.j@email.com', phone: '+971 56 456 7890', nationality: 'USA', applications: 4, totalSpent: 2100, lastActive: '5 hr ago' },
  { id: '5', name: 'Ravi Kumar', email: 'ravi.k@email.com', phone: '+971 54 567 8901', nationality: 'India', applications: 2, totalSpent: 843, lastActive: '1 day ago' },
  { id: '6', name: 'Fatima Al Mansouri', email: 'fatima@email.com', phone: '+971 50 678 9012', nationality: 'UAE', applications: 1, totalSpent: 385, lastActive: '2 days ago' },
  { id: '7', name: 'James Wilson', email: 'j.wilson@email.com', phone: '+971 55 789 0123', nationality: 'UK', applications: 3, totalSpent: 1575, lastActive: '2 days ago' },
  { id: '8', name: 'Lina Farouk', email: 'lina.f@email.com', phone: '+971 52 890 1234', nationality: 'Egypt', applications: 1, totalSpent: 320, lastActive: '3 days ago' },
  { id: '9', name: 'Chen Wei', email: 'chen.w@email.com', phone: '+971 56 901 2345', nationality: 'China', applications: 2, totalSpent: 1100, lastActive: '4 days ago' },
  { id: '10', name: 'Omar Siddiqui', email: 'omar.s@email.com', phone: '+971 54 012 3456', nationality: 'Bangladesh', applications: 1, totalSpent: 275, lastActive: '5 days ago' },
  { id: '11', name: 'Emily Brown', email: 'emily.b@email.com', phone: '+971 50 123 7890', nationality: 'USA', applications: 2, totalSpent: 650, lastActive: '1 week ago' },
  { id: '12', name: 'Hassan Malik', email: 'h.malik@email.com', phone: '+971 55 234 8901', nationality: 'Pakistan', applications: 1, totalSpent: 520, lastActive: '1 week ago' },
  { id: '13', name: 'Nadia Petrova', email: 'nadia.p@email.com', phone: '+971 52 345 9012', nationality: 'Russia', applications: 1, totalSpent: 410, lastActive: '2 weeks ago' },
  { id: '14', name: 'Kevin Okafor', email: 'kevin.o@email.com', phone: '+971 56 456 0123', nationality: 'Nigeria', applications: 2, totalSpent: 890, lastActive: '2 weeks ago' },
  { id: '15', name: 'Maria Santos', email: 'maria.s@email.com', phone: '+971 54 567 1234', nationality: 'Philippines', applications: 3, totalSpent: 1200, lastActive: '3 weeks ago' },
]

export const MOCK_AGENTS: AdminAgent[] = [
  { id: '1', name: 'Mohammed Travel', email: 'info@mohammedtravel.ae', leads: 24, revenue: 8400, commission: 840, status: 'Active' },
  { id: '2', name: 'Al Faris Agency', email: 'contact@alfaris.ae', leads: 18, revenue: 6300, commission: 630, status: 'Active' },
  { id: '3', name: 'Gulf Visa Center', email: 'hello@gulfvisa.ae', leads: 15, revenue: 5250, commission: 525, status: 'Active' },
  { id: '4', name: 'Dubai Travel Co.', email: 'sales@dubaitravel.ae', leads: 12, revenue: 4200, commission: 420, status: 'Active' },
  { id: '5', name: 'Emirates Visa Hub', email: 'support@evhub.ae', leads: 10, revenue: 3500, commission: 350, status: 'Active' },
  { id: '6', name: 'Global Pathways', email: 'info@globalpath.ae', leads: 8, revenue: 2800, commission: 280, status: 'Inactive' },
  { id: '7', name: 'Visa Express UAE', email: 'team@visaexpress.ae', leads: 7, revenue: 2450, commission: 245, status: 'Active' },
  { id: '8', name: 'Horizon Travels', email: 'book@horizon.ae', leads: 5, revenue: 1750, commission: 175, status: 'Active' },
]

export const MOCK_INVOICES: AdminInvoice[] = [
  { id: '1', invoiceNo: 'ATL48291034', customer: 'Ahmed Hassan', destination: 'Kenya', amount: 462, govFee: 289, processingFee: 173, status: 'PAID', date: '2026-06-03', countryCode: 'ke' },
  { id: '2', invoiceNo: 'ATL48291035', customer: 'Priya Sharma', destination: 'UK', amount: 843, govFee: 520, processingFee: 323, status: 'UNPAID', date: '2026-06-02', countryCode: 'gb' },
  { id: '3', invoiceNo: 'ATL48291036', customer: 'Mohammed Ali', destination: 'Schengen', amount: 520, govFee: 347, processingFee: 173, status: 'OVERDUE', date: '2026-05-28', countryCode: 'fr' },
  { id: '4', invoiceNo: 'ATL48291037', customer: 'Sarah Johnson', destination: 'USA', amount: 1200, govFee: 800, processingFee: 400, status: 'PAID', date: '2026-06-01', countryCode: 'us' },
  { id: '5', invoiceNo: 'ATL48291038', customer: 'Ravi Kumar', destination: 'Canada', amount: 650, govFee: 400, processingFee: 250, status: 'PAID', date: '2026-05-30', countryCode: 'ca' },
  { id: '6', invoiceNo: 'ATL48291039', customer: 'Fatima Al Mansouri', destination: 'Schengen', amount: 385, govFee: 250, processingFee: 135, status: 'UNPAID', date: '2026-05-29', countryCode: 'fr' },
  { id: '7', invoiceNo: 'ATL48291040', customer: 'James Wilson', destination: 'Australia', amount: 720, govFee: 450, processingFee: 270, status: 'PAID', date: '2026-05-27', countryCode: 'au' },
  { id: '8', invoiceNo: 'ATL48291041', customer: 'Lina Farouk', destination: 'Thailand', amount: 275, govFee: 150, processingFee: 125, status: 'REFUNDED', date: '2026-05-25', countryCode: 'th' },
  { id: '9', invoiceNo: 'ATL48291042', customer: 'Chen Wei', destination: 'UK', amount: 890, govFee: 550, processingFee: 340, status: 'OVERDUE', date: '2026-05-22', countryCode: 'gb' },
  { id: '10', invoiceNo: 'ATL48291043', customer: 'Omar Siddiqui', destination: 'Malaysia', amount: 310, govFee: 180, processingFee: 130, status: 'PAID', date: '2026-05-20', countryCode: 'my' },
  { id: '11', invoiceNo: 'ATL48291044', customer: 'Emily Brown', destination: 'Kenya', amount: 462, govFee: 289, processingFee: 173, status: 'UNPAID', date: '2026-05-18', countryCode: 'ke' },
  { id: '12', invoiceNo: 'ATL48291045', customer: 'Hassan Malik', destination: 'Canada', amount: 680, govFee: 420, processingFee: 260, status: 'PAID', date: '2026-05-15', countryCode: 'ca' },
  { id: '13', invoiceNo: 'ATL48291046', customer: 'Nadia Petrova', destination: 'UAE', amount: 350, govFee: 200, processingFee: 150, status: 'OVERDUE', date: '2026-05-12', countryCode: 'ae' },
  { id: '14', invoiceNo: 'ATL48291047', customer: 'Kevin Okafor', destination: 'UK', amount: 920, govFee: 580, processingFee: 340, status: 'PAID', date: '2026-05-10', countryCode: 'gb' },
  { id: '15', invoiceNo: 'ATL48291048', customer: 'Maria Santos', destination: 'Singapore', amount: 295, govFee: 165, processingFee: 130, status: 'UNPAID', date: '2026-05-08', countryCode: 'sg' },
]
...
export const MOCK_EXPENSES: AdminExpense[] = [
  ...
  { id: '9', category: 'Salary', description: 'Agent commission payout', amount: 8400, date: '2026-05-01', addedBy: 'Super Admin', hasReceipt: true },
...
export const MOCK_ACTIVITIES: AdminActivity[] = [
  ...
  { id: '2', type: 'lead', text: 'New lead — Fatima Al Mansouri (Schengen)', time: '8 min ago' },
  ...
  { id: '5', type: 'agent', text: 'New agent registered — Dubai Travel Co.', time: '1 hr ago' },
  ...
  { id: '9', type: 'lead', text: 'New lead — Tom Becker (Kenya)', time: '5 hr ago' },
...
export function getStatusColor(status: LeadStatus): { bg: string; color: string; border: string } {
  const map: Record<string, { bg: string; color: string; border: string }> = {
    'New Lead': { bg: '#f8f9fc', color: '#6b7280', border: '#e5e7eb' },
