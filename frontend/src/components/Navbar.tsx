...
export function Navbar({
  ...
  const { profilePhotoUrl: authProfilePhotoUrl } = useAuth()
  const resolvedProfilePhoto = profilePhotoUrl ?? authProfilePhotoUrl ?? undefined
  const {
    countryCode,
    citizenship,
    residenceCode,
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {isLoggedIn && resolvedProfilePhoto ? (
            <img
